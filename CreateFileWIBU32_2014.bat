...
rem del %drive%\ReleaseCodeMeter32\TX_Option.xml
rem copy %drive%\ReleaseCodeMeter32\TX_Option_TJAD.xml %drive%\ReleaseCodeMeter32\TX_Option.xml
rem "%programfile%\Inno Setup 5\compil32" /cc %~dp0\TX_InnoSetup_32.iss
rem copy %drive%\setup.exe %drive%\setupwb32(%dt%).exe
...
"%programfile%\Inno Setup 5\compil32" /cc %~dp0\TX_InnoSetup_BridgeWise32_2014.iss
copy %drive%\BridgeWise32For2014.exe %drive%\BridgeWiseFor2014(%dt%)(32Œªº”√‹À¯∞Ê±æ).exe