...
del %drive%\ReleaseXencode64\TX_VAEntity.dll
del %drive%\ReleaseXencode64\TX_VBEntity.dll
...
copy %drive%\BridgeWise64For2010.exe %drive%\BridgeWiseFor2010(%dt%)(64Œªº”√‹À¯∞Ê).exe
