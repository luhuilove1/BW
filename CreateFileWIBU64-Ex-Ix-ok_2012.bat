...
"%programfile%\Inno Setup 5\compil32" /cc %~dp0\TX_InnoSetup_BridgeWise64_2012.iss
copy %drive%\BridgeWise64For2012.exe %drive%\BridgeWiseFor2012(%dt%)(64Œªº”√‹À¯∞Ê).exe