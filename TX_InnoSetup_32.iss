...
begin
  if CurStep=ssPostInstall then
     if  (CheckBox1.Checked) then
        begin
        RegWriteStringValue(HKEY_LOCAL_MACHINE, 'SOFTWARE\Autodesk\AutoCAD\R18.0\ACAD-8001:804\Applications\BADesign', 'LOADER',  ExpandConstant('{app}')+'\TX_START.dll');
        RegWriteStringValue(HKEY_LOCAL_MACHINE, 'SOFTWARE\Autodesk\AutoCAD\R18.0\ACAD-8001:804\Applications\BADesign', 'DESCRIPTION', '使BADesign随CAD启动！');
        RegWriteDWordValue(HKEY_LOCAL_MACHINE, 'SOFTWARE\Autodesk\AutoCAD\R18.0\ACAD-8001:804\Applications\BADesign', 'LOADCTRLS', 2);
        RegWriteDWordValue(HKEY_LOCAL_MACHINE, 'SOFTWARE\Autodesk\AutoCAD\R18.0\ACAD-8001:804\Applications\BADesign', 'MANAGED', 1);
        end;
     if  (CheckBox2.Checked) then
        begin
        RegWriteStringValue(HKEY_LOCAL_MACHINE, 'SOFTWARE\Autodesk\AutoCAD\R18.1\ACAD-9001:804\Applications\BADesign', 'LOADER',  ExpandConstant('{app}')+'\TX_START.dll');
        RegWriteStringValue(HKEY_LOCAL_MACHINE, 'SOFTWARE\Autodesk\AutoCAD\R18.1\ACAD-9001:804\Applications\BADesign', 'DESCRIPTION', '使BADesign随CAD启动！');
        RegWriteDWordValue(HKEY_LOCAL_MACHINE, 'SOFTWARE\Autodesk\AutoCAD\R18.1\ACAD-9001:804\Applications\BADesign', 'LOADCTRLS', 2);
        RegWriteDWordValue(HKEY_LOCAL_MACHINE, 'SOFTWARE\Autodesk\AutoCAD\R18.1\ACAD-9001:804\Applications\BADesign', 'MANAGED', 1);
        end;
end;
...
[Files]
Source: "M:\ReleaseCodeMeter32\加载程序.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "M:\ReleaseCodeMeter32\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
