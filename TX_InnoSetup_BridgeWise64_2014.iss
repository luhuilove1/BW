...
OutputDir=M:\
OutputBaseFilename=BridgeWise64For2014
Compression=lzma
...
;ACAD2010 := RegvalueExists(HKLM, 'SOFTWARE\Autodesk\AutoCAD\R18.0\ACAD-8001:409','AcadLocation');  ---------- 原来是这个号码，但是找不到版本，这个可能是英文版本吧
; -- IsWin64  是判断操作系统的方法
[code]
 var
  Page: TWizardPage; 
...
begin
  if CurStep=ssPostInstall then
     if  (CheckBox1.Checked) then
        ...
        RegWriteStringValue(HKLM64, 'SOFTWARE\Autodesk\AutoCAD\R18.0\ACAD-8001:804\Applications\BridgeWise', 'DESCRIPTION', '使BridgeWise随CAD启动！');
     ...
     if  (CheckBox2.Checked) then
        ...
        RegWriteStringValue(HKLM64, 'SOFTWARE\Autodesk\AutoCAD\R18.1\ACAD-9001:804\Applications\BridgeWise', 'DESCRIPTION', '使BridgeWise随CAD启动！');
     ...
     if  (CheckBox3.Checked) then
        begin
        RegWriteStringValue(HKLM64, 'SOFTWARE\Autodesk\AutoCAD\R18.2\ACAD-A001:804\Applications\BridgeWise', 'LOADER',  ExpandConstant('{app}')+'\TX_START.dll');
        RegWriteStringValue(HKLM64, 'SOFTWARE\Autodesk\AutoCAD\R18.2\ACAD-A001:804\Applications\BridgeWise', 'DESCRIPTION', '使BridgeWise随CAD启动！');
        RegWriteDWordValue(HKLM64, 'SOFTWARE\Autodesk\AutoCAD\R18.2\ACAD-A001:804\Applications\BridgeWise', 'LOADCTRLS', 2);
        RegWriteDWordValue(HKLM64, 'SOFTWARE\Autodesk\AutoCAD\R18.2\ACAD-A001:804\Applications\BridgeWise', 'MANAGED', 1);
        end;
     if  (CheckBox4.Checked) then
        begin
        RegWriteStringValue(HKLM64, 'SOFTWARE\Autodesk\AutoCAD\R19.0\ACAD-B001:804\Applications\BridgeWise', 'LOADER',  ExpandConstant('{app}')+'\TX_START.dll');
        RegWriteStringValue(HKLM64, 'SOFTWARE\Autodesk\AutoCAD\R19.0\ACAD-B001:804\Applications\BridgeWise', 'DESCRIPTION', '使BridgeWise随CAD启动！');
        RegWriteDWordValue(HKLM64, 'SOFTWARE\Autodesk\AutoCAD\R19.0\ACAD-B001:804\Applications\BridgeWise', 'LOADCTRLS', 2);
        RegWriteDWordValue(HKLM64, 'SOFTWARE\Autodesk\AutoCAD\R19.0\ACAD-B001:804\Applications\BridgeWise', 'MANAGED', 1);
        end;		
...
;Root: HKLM; Subkey: "SOFTWARE\Autodesk\AutoCAD\R18.0\ACAD-8001:409\Applications\KAKANIMOTools111"; ValueType: string; ValueName: "DESCRIPTION"; ValueData: "使KAKANIMOTools随CAD启动！"
